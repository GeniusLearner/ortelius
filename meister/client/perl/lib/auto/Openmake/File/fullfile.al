...
#line 378 "C:/Work/Catalyst/SourceCode/Openmake640_Trunk/perl/lib/Openmake/File.pm (autosplit into perl\lib\auto\Openmake\File\fullfile.al)"
#----------------------------------------------------------------
#-- stand-ins for symbol table magic
#
sub fullfile { my $self = shift; return $self->set(@_); }
# end of Openmake::File::fullfile
1;
