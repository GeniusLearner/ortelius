...
BEGIN
{
 ...
 my $HEADER = '$Header: /CVS/openmake64/perl/lib/DEBUG/Openmake/File.pm,v 1.2 2005/06/13 19:56:49 jim Exp $'; 
 ...
 @ISA     = qw( Exporter Openmake::Load Openmake::Path AutoLoader );
 @EXPORT  = qw( &CleanPath );
} #-- End: BEGIN
