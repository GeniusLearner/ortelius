...
<xsl:template name="packageSummaryHeader">
    <tr class="TableHeader" valign="top">
        ...
        <td width="10%"><b>Success Rate</b></td>
        <td width="5%"><b>Pass/Fail</b></td>
        <td width="5%"><b>Success</b></td>
        <td width="5%"><b>Failure</b></td>
        <td width="5%"><b>Error</b></td>
...
-->
    <xsl:template name="summary">
        <h2>Summary</h2>
        <xsl:variable name="testCount" select="(/test-results/@total)"/>
        <xsl:variable name="errorCount" select="sum(./testsuite/@errors)"/>
        <xsl:variable name="failureCount" select="(/test-results/@failures)"/>
        <xsl:variable name="timeCount" select="(/test-results/@time)"/>
