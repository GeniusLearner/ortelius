...
my $choose_os = "";
my $choose_dir = "";
my $plugins_dir = 'G:\catalyst\om_build\700\winxp-lionel\java\build\RELEASE\java';
my $installer_script = 'F:\CVS\openmake7\tools\headless_installer\installer.pl';
...
foreach my $os (@OSes)
{
 ...
 copy ('installer.pl', $os) or die "Cannot copy file: 'installer.pl'";
